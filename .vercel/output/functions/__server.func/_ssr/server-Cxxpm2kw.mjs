...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BN4LJB_w.mjs");
...
const manifest = {
  "c26f4276f2cf83df23663f2a76b4205ee1255d84354c2e4025363300aa382e41": {
    functionName: "analyzeMovement_createServerFn_handler",
    importer: () => import("./analysis.functions-DuAtbuGs.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DVo0osGK.mjs").then((n) => n.r),
    import("./start-Cmvem25p.mjs"),
